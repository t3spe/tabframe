...
| [`walkthrough.md`](walkthrough.md) | the page's contract: the five-click tour, then every screen, state, and control, checked by `e2e/walkthrough.e2e.ts` |
| [`development.md`](development.md) | the machine on a laptop, every task, what the tests prove and how to run them, what CI runs, the conventions |

...
| WP2.2 | [wp-2.2-wordcount.md](wp-2.2-wordcount.md) | pending | Word count: three-stage map/reduce/merge over Moby-Dick with range ownership by word start, FNV-1a partitions, the `bars` payload, a staged host and goldens |

...
| WP5.1 | [wp-5.1-packaging.md](wp-5.1-packaging.md) | 2026-09-02 | Packaging: the README for a cold reviewer, the rationale draft answering the five questions, and the scrubbing transcript export tool behind `mise run transcripts` |
...
| WP7.4 | [wp-7.4-files-ledger-in-page.md](wp-7.4-files-ledger-in-page.md) | 2026-09-03 | Files and ledger rows show their bytes in a preview box that is always there; a click changes a class, never the list; the new tab and the raw bytes are small secondary links. |
| WP7.5 | [wp-7.5-editor-layout-guide.md](wp-7.5-editor-layout-guide.md) | 2026-09-04 | The editor fills the viewport (source left, launch column right, one action bar); the guide is its own page behind "What is a program? ↗" at the top. |
| WP7.6 | [wp-7.6-programs-with-source.md](wp-7.6-programs-with-source.md) | 2026-09-04 | The manifest names the program's source in the store; the seeder stores every shipped program's; the editor lists every program on the machine and opens it with its source and its inputs by hash. |
| WP7.7 | [wp-7.7-walkthrough.md](wp-7.7-walkthrough.md) | 2026-09-04 | The walkthrough: `docs/walkthrough.md` as the page's contract (every screen × state × control, eight rules), the sentence of state in the status line, reasons in tooltips instead of hidden controls, ways back, an honest editor, and a browser test that asserts each state. |
| WP8.1 | [wp-8.1-review-loop-1.md](wp-8.1-review-loop-1.md) | 2026-09-04 | Review loop 1: five personas, 52 findings aggregated and critiqued, 40 landed with tests across core, protocol, sandbox, store, node, control plane, fleet, infra, tooling, web, and docs. |

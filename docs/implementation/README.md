...
| WP1.8 | [wp-1.8-dashboard-v1.md](wp-1.8-dashboard-v1.md) | pending | Dashboard: verified tiles on the canvas with state overlay, task grid, counters, throughput, controls over the socket, notices, demo mode |

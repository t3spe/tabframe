...
One line per session. **Developer time** is Mircea's hours. **Total time** is the wall-clock of the
session with the agent working. The rationale states the developer total and shows the total alongside.

| Date | Developer time (h) | Total time (h) | What |
|---|---|---|---|
